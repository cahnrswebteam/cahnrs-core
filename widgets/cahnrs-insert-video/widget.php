...
class cahnrs_insert_video extends \WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			'cahnrs_insert_video', // Base ID 
			'Video', // Name
			array( 'description' => 'Insert video into page.', ) // Args
		);
...
add_action( 'widgets_init', function(){
	register_widget( 'cahnrs_insert_video' );
});
